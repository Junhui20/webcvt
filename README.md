...
- **29 packages** shipped across Phases 1–7 (`@catlabtech/webcvt-core` + 11 image/codec, 9 container, 2 data/subtitle, 1 email, 1 ebook, 1 CLI, 3 ancillary)
- **4,647 tests** passing; CI green
