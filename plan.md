...
| ~~`container-mp4` second-pass (video, fragmented, edit lists, multi-track, iTunes metadata)~~ | ✅ done — 442 tests; **only `sidx`/`mfra` typed-parse + DRM (cenc/pssh) still out** |
