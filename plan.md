...
- **License:** MIT
- **Status:** **Phase 1: 7/8 · Phase 2: 7/8 · Phase 3: 5/6 (4 first-pass containers + `@webcvt/ebml` extracted from webm/mkv duplicated primitives) · Phase 4: 5/5 ✅ COMPLETE · Phase 5: 1/8 (`@webcvt/cli` first-pass shipped)** · CI green · 2,676 tests passing · 22 packages · last revised 2026-04-20
