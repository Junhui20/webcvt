...
- **License:** MIT
- **Status:** **Phase 1: 7/8 · Phase 2: 7/8 · Phase 3: 5/6 · Phase 4: 5/5 ✅ COMPLETE · Phase 4.5: 8/N (image-legacy TIFF + TGA + XBM + PCX + XPM, data-text JSONL + TOML + FWF) · Phase 5: 2/8 (`@webcvt/cli` + `@webcvt/backend-wasm`)** · CI green · 3,397 tests passing · 22 packages · last revised 2026-04-21
