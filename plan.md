...
- **License:** MIT
- **Status:** **Phase 1: 7/8 · Phase 2: 7/8 · Phase 3: 5/6 · Phase 4: 5/5 ✅ COMPLETE · Phase 4.5: 6/N (image-legacy TIFF + TGA + XBM + PCX, data-text JSONL + TOML) · Phase 5: 2/8 (`@webcvt/cli` + `@webcvt/backend-wasm`)** · CI green · 3,279 tests passing · 22 packages · last revised 2026-04-20
